...
* Set up a serverless backend to store, manage, and synchronize data (data management and persistence) with the Firebase Cloudstore and Firebase Storage
* Create and manage users with Google sign-in and Firebase auth.
* Depliy our single page application to the cloud with Firebase hosting.
